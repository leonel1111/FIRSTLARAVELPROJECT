        ...
        <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form action="/register" method="POST" id="registration-form">
            ...
            <div class="form-group">
              ...
              {{-- old function handles the data inputted and saves it when the user gets an error when inputting data --}}
              ...
              {{-- error message handled by laravel but is determined by the constraints or validation in the usercontroller class --}}
              @error('username')
              <p class="m-0 small alert alert-danger shdadow-sm">{{$message}}</p>
              @enderror
            </div>
